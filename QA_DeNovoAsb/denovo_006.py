...
# API token ---->  DEV-5537b911668962951db3146e57c133ccc9a82a5f

# Available QPUs
# 	DW_2000Q_2_1 
# 		2038 qubits
# 		1-10s estimated waiting time
# 		14.5±1mK qubit temperature
# 	DW_2000Q_5
# 		2030 qubits
# 		1-10s estimated waiting time
# 		13.5±1mK qubit temperature

# Solver API endpoint https://cloud.dwavesys.com/sapi
